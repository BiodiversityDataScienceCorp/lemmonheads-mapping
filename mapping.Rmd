...
write_csv(lemmonData, "lemmonDataGood.csv")
...
plot(wrld_simpl, 
     ...
     axes = TRUE, 
     col = "grey95",
     main="Lemmon's Milkweed species occurrences in Arizona and Mexico",  # a title
     sub="131 occurrences of Lemmon's Milkweed" # a caption
     )
